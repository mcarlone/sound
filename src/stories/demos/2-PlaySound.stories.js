...
export const FartHands = () => {
  ...
  const [playFart1] = useSound(fart1Sfx, {playbackRate:1.0 + Math.random() * 1.5});
  const [playFart2] = useSound(fart2Sfx, {playbackRate:1.0 + Math.random() * 1.5});
...
export const BasicPlayback = () => {
  return (<div>Hello!<FartHands/></div>);
};
